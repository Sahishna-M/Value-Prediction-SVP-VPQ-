...
// VPU 
bool vp_pred_INTALU = false;
bool vp_pred_FPALU = false;
bool vp_pred_LOAD = false;

// Initialise the global variables of VPQ
uint64_t VP_VPQ_SIZE       = 0;
bool     VP_ORACLE_CONF    = false;
uint64_t VP_NUM_INDEX_BITS = 0;
uint64_t VP_NUM_TAG_BITS   = 0;
uint64_t VP_CONF_MAX       = 0;
bool     VP_USE_SVP        = false;
bool     VP_USE_PERF       = false;
