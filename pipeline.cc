...
pipeline_t::pipeline_t(
   ...
   /////////////////////////////////////////////////////////////
   // Value Prediction Configuration (defaults)
   /////////////////////////////////////////////////////////////
   this->predINTALU = vp_pred_INTALU;
   this->predFPALU  = vp_pred_FPALU;
   this->predLOAD   = vp_pred_LOAD;
...
// VPU initialization
void pipeline_t::init_vpu(uint64_t vpq_size, uint64_t num_index_bits,
                           uint64_t num_tag_bits, uint64_t conf_max,
                           bool perf_mode, bool oracle_conf){
    VPU = new vpu_t(vpq_size, num_index_bits, num_tag_bits,
                    conf_max, perf_mode, oracle_conf);
}
